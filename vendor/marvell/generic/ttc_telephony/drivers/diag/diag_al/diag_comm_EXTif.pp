//PPL Source File Name : ../diag/diag_al/diag_comm_EXTif.i
//PPL Source File Name : diag_comm_EXTif.c
...
typedef void VOID ;typedef int ( *DiagRxCallbackFunc ) ( char* packet , int len ) ;typedef void* OSATaskRef ;typedef void* OSASemaRef ;typedef void* OSAMutexRef ;typedef void* OSAMsgQRef ;typedef void* OSAMailboxQRef ;typedef void* OSAPoolRef ;typedef void* OSATimerRef ;typedef void* OSAFlagRef ;typedef UINT8 OSA_STATUS ;typedef void* OSTaskRef ;typedef void* OSSemaRef ;typedef void* OSMutexRef ;typedef void* OSMsgQRef ;typedef void* OSMailboxQRef ;typedef void* OSPoolRef ;typedef void* OSTimerRef ;typedef void* OSFlagRef ;typedef UINT8 OS_STATUS ;typedef union sigval {
 int sival_int ;
 void *sival_ptr ;
 } sigval_t ;typedef unsigned long sigset_t ;typedef void __signalfn_t ( int ) ;typedef __signalfn_t *__sighandler_t ;typedef void __restorefn_t ( void ) ;typedef __restorefn_t *__sigrestore_t ;typedef int sig_atomic_t ;typedef void ( *sig_t ) ( int ) ;typedef sig_t sighandler_t ;typedef long pthread_mutexattr_t ;typedef long pthread_condattr_t ;typedef int pthread_key_t ;typedef long pthread_t ;typedef volatile int pthread_once_t ;typedef int pthread_rwlockattr_t ;typedef void ( *__pthread_cleanup_func_t ) ( void* ) ;typedef __kernel_fd_set fd_set ;typedef UINT32 OS_Hisr_t ;typedef UINT32 OS_MemPool_t ;typedef pid_t OS_Proc_t ;typedef void ( *funcPtrType ) ( void* ) ;typedef void ( *timerCBPtrType ) ( UINT32 ) ;typedef void ( *FunctionPtr ) ( void * , UINT32 ) ;typedef void ( *RSVPFunctionPtr ) ( void * , UINT32 , UINT32 ) ;typedef union {
 UINT8 packedMsgData [ 13 ] ;
 UINT8 msgData [ 13 ] ;
 } PackedUnPackedData ;typedef void ( *CommandAddress ) ( void ) ;typedef char* CommandProto ;typedef const char * DiagDBVersion ;//ICAT EXPORTED ENUM 
 typedef enum 
 {	 
 PROTOCOL_TYPE_0 = 0 ,	 
 MAX_PROTOCOL_TYPES	 
...
typedef void ( *MMI_STOP_CB_Func ) ( void ) ;typedef void ( *MMI_START_CB_Func ) ( const char* rel_path ) ;//ICAT EXPORTED STRUCT 
 typedef struct 
 {	 
