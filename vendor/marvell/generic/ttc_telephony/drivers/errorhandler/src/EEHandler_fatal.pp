//PPL Source File Name : ../errorhandler/src/EEHandler_fatal.i
//PPL Source File Name : src/EEHandler_fatal.c
...
typedef unsigned long sigset_t ;typedef void __signalfn_t ( int ) ;typedef __signalfn_t *__sighandler_t ;typedef void __restorefn_t ( void ) ;typedef __restorefn_t *__sigrestore_t ;typedef int sig_atomic_t ;typedef void ( *sig_t ) ( int ) ;typedef sig_t sighandler_t ;typedef __kernel_fd_set fd_set ;DIAG_FILTER ( EE_HANDLER , EE_LOG , logOpen , DIAG_INFORMATION)  
