//PPL Source File Name : ../errorhandler/src/EEHandler_config.i
//PPL Source File Name : src/EEHandler_config.c
...
typedef __gnuc_va_list va_list ;//ICAT EXPORTED FUNCTION - EE_HANDLER , EE , eePrintConfiguration 
