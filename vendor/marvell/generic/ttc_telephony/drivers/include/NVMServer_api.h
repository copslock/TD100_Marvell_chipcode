...
* Notes:
*******************************************************************************/
NVM_STATUS_T NVMS_FileOpen( NVM_CLIENT_ID ClientID, LPCTSTR szFileName, LPCTSTR szAttrib, PUINT32 phFile);
...
* Notes:
*******************************************************************************/
NVM_STATUS_T NVMS_FileWrite( NVM_CLIENT_ID ClientID, UINT32 hFile, LPVOID pBuffer, UINT32 dwBufferLen, short wItemSize, UINT32 dwCount, PUINT32 pdwActual);
...
* Notes:
*******************************************************************************/
NVM_STATUS_T NVMS_FileRead( NVM_CLIENT_ID ClientID, UINT32 hFile, short wItemSize, UINT32 dwCount, PUINT32 pdwActual, LPVOID pBuffer);
