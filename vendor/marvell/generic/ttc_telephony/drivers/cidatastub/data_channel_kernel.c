...
static int cidatastubsockfd;
static int cicsdstubsockfd;
static DataRxCallbackFunc dataRxCbFunc[4] = { NULL, NULL, NULL, NULL };

struct task_struct *ciDataRcvTaskRef;
...
#ifdef CS_PS_PORTS
	ciCsdRcvTaskRef = kthread_run(ciCsdRcvDataTask, NULL,
				      "ciCsdRcvDataTask");

	ciCsdInitTaskRef = kthread_run(ciCsdDataInitTask, NULL,
				       "ciCsdDataInitTask");
#endif
