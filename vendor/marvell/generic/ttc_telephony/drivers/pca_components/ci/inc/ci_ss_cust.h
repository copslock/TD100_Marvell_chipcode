...
/* ===========================================================================
   File        : ci_ss_cust.h
   Description : Data types file for the SS Service Group; customer extensions
   Notes       :
...
#if !defined(_CI_SS_CUST_H_)
#define _CI_SS_CUST_H_
...
/* currently there are no SS customer extension primitives required,
 ...
 * The CI_SS_NUM_CUST_PRIM will be redefined in that file
 */
#define CI_SS_NUM_CUST_PRIM 0

/* template to add new customer include file */
/*
 * #ifdef CI_CUST_newCustomerAcronym_EXTENSION
 * #include "ci_ss_cust_newCustomerAcronym.h"
 * #endif
 */
