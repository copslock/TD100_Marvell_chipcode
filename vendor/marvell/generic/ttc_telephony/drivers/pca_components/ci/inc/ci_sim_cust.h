...
/* ===========================================================================
   File        : ci_sim_cust.h
   Description : Data types file for the SIM Service Group; customer extensions
   Notes       :
...
#if !defined(_CI_SIM_CUST_H_)
#define _CI_SIM_CUST_H_
...
/* currently there are no SIM customer extension primitives required,
 ...
 * The CI_SIM_NUM_CUST_PRIM will be redefined in that file
 */
#define CI_SIM_NUM_CUST_PRIM 0

/* template to add new customer include file */
/*
 * #ifdef CI_CUST_newCustomerAcronym_EXTENSION
 * #include "ci_sim_cust_newCustomerAcronym.h"
 * #endif
 */
