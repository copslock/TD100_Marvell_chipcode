...
/*===========================================================================
   File        : ci_cc_cust.h
   Description : Data types file for the CC Service Group; customer extensions
   Notes       :
...
#if !defined(_CI_CC_CUST_H_)
#define _CI_CC_CUST_H_
...
/* currently there are no CC customer extension primitives required,
 ...
 * The CI_CC_NUM_CUST_PRIM will be redefined in that file
 */
#define CI_CC_NUM_CUST_PRIM 0

/* template to add new customer include file */
/*
 * #ifdef CI_CUST_newCustomerAcronym_EXTENSION
 * #include "ci_cc_cust_newCustomerAcronym.h"
 * #endif
 */
