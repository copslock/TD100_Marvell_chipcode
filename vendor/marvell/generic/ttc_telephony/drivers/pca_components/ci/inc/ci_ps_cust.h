...
/* ===========================================================================
   File        : ci_ps_cust.h
   Description : Data types file for the PS Service Group; customer extensions
   Notes       :
...
#if !defined(_CI_PS_CUST_H_)
#define _CI_PS_CUST_H_
...
/* currently there are no PS customer extension primitives required,
 ...
 * The CI_PS_NUM_CUST_PRIM will be redefined in that file
 */
#define CI_PS_NUM_CUST_PRIM 0

/* template to add new customer include file */
/*
 #ifdef CI_CUST_newCustomerAcronym_EXTENSION
 #include "ci_ps_cust_newCustomerAcronym.h"
 #endif
 */
