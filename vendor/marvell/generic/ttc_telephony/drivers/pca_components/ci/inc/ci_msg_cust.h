...
/* ===========================================================================
   File        : ci_msg_cust.h
   Description : Data types file for the MSG Service Group; customer extensions
   Notes       :
...
#if !defined(_CI_MSG_CUST_H_)
#define _CI_MSG_CUST_H_
...
/* currently there are no MSG customer extension primitives required,
 ...
 * The CI_MSG_NUM_CUST_PRIM will be redefined in that file
 */
#define CI_MSG_NUM_CUST_PRIM 0

/* template to add new customer include file */
/*
 * #ifdef CI_CUST_newCustomerAcronym_EXTENSION
 * #include "ci_msg_cust_newCustomerAcronym.h"
 * #endif
 */
