...
/* ===========================================================================
   File        : ci_dev_cust.h
   Description : Data types file for the DEV Service Group; customer extensions
   Notes       :
...
#if !defined(_CI_DEV_CUST_H_)
#define _CI_DEV_CUST_H_
...
/* currently there are no DEV customer extension primitives required,
 ...
 * The CI_DEV_NUM_CUST_PRIM will be redefined in that file
 */
#define CI_DEV_NUM_CUST_PRIM 0

/* template to add new customer include file */
/*
 * #ifdef CI_CUST_newCustomerAcronym_EXTENSION
 * #include "ci_dev_cust_newCustomerAcronym.h"
 * #endif
 */
