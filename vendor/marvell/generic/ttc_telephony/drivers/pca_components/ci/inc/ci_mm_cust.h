...
/* ===========================================================================
   File        : ci_mm_cust.h
   Description : Data types file for the MM Service Group; customer extensions
   Notes       :
...
#if !defined(_CI_MM_CUST_H_)
#define _CI_MM_CUST_H_
...
/* currently there are no MM customer extension primitives required,
 ...
 * The CI_MM_NUM_CUST_PRIM will be redefined in that file
 */
#define CI_MM_NUM_CUST_PRIM 0

/* template to add new customer include file */
/*
 * #ifdef CI_CUST_newCustomerAcronym_EXTENSION
 * #include "ci_mm_cust_newCustomerAcronym.h"
 * #endif
 */
