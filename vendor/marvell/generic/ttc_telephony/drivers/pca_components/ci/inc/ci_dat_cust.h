...
/* ===========================================================================
   File        : ci_dat_cust.h
   Description : Data types file for the DAT Service Group; customer extensions
   Notes       :
...
#if !defined(_CI_DAT_CUST_H_)
#define _CI_DAT_CUST_H_
...
/* currently there are no DAT customer extension primitives required,
 ...
 * The CI_DAT_NUM_CUST_PRIM will be redefined in that file
 */
#define CI_DAT_NUM_CUST_PRIM 0

/* template to add new customer include file */
/*
 #ifdef CI_CUST_newCustomerAcronym_EXTENSION
 #include "ci_dat_cust_newCustomerAcronym.h"
 #endif
 */
