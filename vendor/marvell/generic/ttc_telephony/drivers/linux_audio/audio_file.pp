//PPL Source File Name : ../linux_audio/audio_file.i
//PPL Source File Name : audio_file.c
...
//ICAT EXPORTED FUNCTION - Audio , HW , AUDIO_HW_TEST 
 ...
 eeh_log ( 5 , " AUDIO DIAG Test:DO Nothing! ha ha ha:%s\n " , arg->Name1 ) ;	 
