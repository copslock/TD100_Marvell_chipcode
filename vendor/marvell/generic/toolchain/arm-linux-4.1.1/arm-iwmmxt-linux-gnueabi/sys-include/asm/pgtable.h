...
/* TEX=001, B=1, C=0 is used by LLR in xscale3(manzano)*/
#ifdef CONFIG_CPU_MONAHANS
#define PMD_SECT_WB		(PMD_SECT_TEX(5) | PMD_SECT_CACHEABLE | PMD_SECT_BUFFERABLE)
#define PMD_SECT_WBWA		(PMD_SECT_TEX(5) | PMD_SECT_CACHEABLE | PMD_SECT_BUFFERABLE)
#else
#define PMD_SECT_WB		(PMD_SECT_CACHEABLE | PMD_SECT_BUFFERABLE)
#define PMD_SECT_WBWA		(PMD_SECT_TEX(1) | PMD_SECT_CACHEABLE | PMD_SECT_BUFFERABLE)
#endif
