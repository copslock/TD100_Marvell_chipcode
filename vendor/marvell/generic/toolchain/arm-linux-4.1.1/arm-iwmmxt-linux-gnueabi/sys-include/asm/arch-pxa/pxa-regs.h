...
#ifdef CONFIG_CPU_MONAHANS /* CONFIG_CPU_MONAHANS */
...
#elif defined(CONFIG_PXA27x) || defined(CONFIG_CPU_MONAHANS)
...
#define MMC_RDWAIT	__REG(0x41100048)  /* reserved for different fifo  */
#define MMC_BLKS_REM	__REG(0x4110004c)  /* SD CMDAT register */
...
#define MMC2_RDWAIT	__REG(0x42000048)  /* reserved for different fifo  */
#define MMC2_BLKS_REM	__REG(0x4200004c)  /* SD CMDAT register */
...
#define	CKEN_GRAPHICS	7	///< Graphics controller clock enable
...
#define CLK_RET_DEL	__REG_2(0x4A0000B0) /* Synchronous Flash Clock Return Dealy Register */
#define ADV_RET_DEL	__REG_2(0x4A0000B4) /* Synchronous Flash nADV Return Delay Register */
#endif
...
#ifdef CONFIG_CPU_MONAHANS_L
#define NDREDEL		__REG_2(0x43100024)  /* NAND Read Enable Return Delay Register */
#endif
...
#define	CISR_SINT	(1 << 31)
#define	CISR_EOFX	(1 << 30)
