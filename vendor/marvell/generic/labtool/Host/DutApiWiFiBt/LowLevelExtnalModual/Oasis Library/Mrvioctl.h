...
#define IOCTL_MRVL_PROVIDE_EXIT_EVENT_HANDLE   \
CTL_CODE(FILE_DEVICE_NETWORK, 0x940, METHOD_BUFFERED, FILE_ANY_ACCESS)
...
#ifdef NDIS_WDM
typedef struct _INFO_SAVED
{
	PDEVICE_OBJECT 	DevObj;
	NDIS_HANDLE 	DevHandle;
	PUNICODE_STRING	RegistryPtr;
...
*/
static INFO_SAVED InfoSaved[MAX_NUM_OF_DEVICES];
#endif

static IOCTL_MUTEX g_CtrlDeviceMutex;
