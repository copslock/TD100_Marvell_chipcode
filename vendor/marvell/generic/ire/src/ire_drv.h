...
#define IRE_PIXFMT_BITS(fmt)	(((fmt >> 5) & 0x3) == 0?16:\
				((fmt >> 7) & 0x3) == 0?32:\
				((fmt >> 7) & 0x3) == 1?16:\
				((fmt >> 7) & 0x3) == 2?12:0)
...
typedef enum {
	...
	IRE_PIXFMT_YUV444_PACKED	= IRE_PIXFMT(0, 0, 1, 3),
	IRE_PIXFMT_YUV444_PLANAR	= IRE_PIXFMT(0, 0, 2, 3),
	IRE_PIXFMT_YUV422_PLANAR	= IRE_PIXFMT(0, 1, 2, 3),
	IRE_PIXFMT_YUV420_PLANAR	= IRE_PIXFMT(0, 2, 2, 3),
	IRE_PIXFMT_YUV422_PACKED	= IRE_PIXFMT(0, 1, 1, 3),
} IRE_PIXEL_FORMAT;
