...
public class BrowserListAdapter extends BaseAdapter
{
	...
	public BrowserListAdapter(Context context, List<Station> list)
	{
		mList = list;
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		if (0 == position)
		{
			view = mInflater.inflate(R.layout.add_station_item, parent, false);
			return view;
		}
		...
		if (item != null) {
			holder.mFreq.setText(String.format("%6s", new BigDecimal(Integer.valueOf(item.mFreq)).divide(new BigDecimal(1000))));
