...
public class STVoiceCall extends FormatActivity {
	/**
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.setContentView(R.layout.playback_index_0_5);
		FormatActivity.StreamType=1;
		FormatActivity.FormatType=0;
	...
	@Override
	public void save() {
		short[] step=new short[6];
		for(int flag=0;flag<=5;flag++)
		{
			EditText et =(EditText)this.findViewById(editID[flag]);
			if(false == FormatActivity.match(et.getText().toString()))
			{
				Toast.makeText(this, "Please input integer between 1 and 120 to Ste"+flag, Toast.LENGTH_LONG).show();
				return;
			}
