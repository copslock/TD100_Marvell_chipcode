...
public class ChangeToMBBMSDialog extends Activity implements OnClickListener, Action{
	private static final String TAG = "ChangeToMBBMSDialog";
	...
	public void onClick(View v) {
		...
		case R.id.bt_confirm:
			LogMask.LOGM(TAG, LogMask.LOG_APP_MAIN, LogMask.getLineInfo(), "choose to change to MBBMS mode",
					LogMask.APP_MAIN);
			sendBroadcast(new Intent().setAction(ACTION_MODE_CHANGED));
			MBBMSService.sInstance.stopModeListen();
			this.finish();
			break;
		case R.id.bt_cancel:
			MBBMSService.sInstance.stopModeListen();
	...
	private void setupView() {
		...
		mPromptTextView.setText(this.getResources().getString(R.string.changetombbms));
	}
