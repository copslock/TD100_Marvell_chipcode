...
public class MBBMSAuthorizeTestAdapter extends BaseAdapter {
	...
	public MBBMSAuthorizeTestAdapter(Context context,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.mChannelTextView = (TextView) convertView
					.findViewById(R.id.tv_interfacetest);
			convertView.setTag(holder);
		} else {
			holder = (ViewHolder) convertView.getTag();
		}
		holder.mChannelTextView.setText(mChannelList.get(position)
				.getChannelName());
		if (position % 2 != 0) {
