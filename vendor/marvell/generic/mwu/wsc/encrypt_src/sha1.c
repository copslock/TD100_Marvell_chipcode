 ...
 */
void
sha1_t_prf(const u8 * key, size_t key_len, const char *label,
 ...
 */
int
tls_prf(const u8 * secret, size_t secret_len, const char *label,
              ...
              size_t ssid_len, int iterations, unsigned int count, u8 * digest)
{
    ...
    /* F(P, S, c, i) = U1 xor U2 xor ... Uc U1 = PRF(P, S || i) U2 = PRF(P, U1)
       Uc = PRF(P, Uc-1) */
