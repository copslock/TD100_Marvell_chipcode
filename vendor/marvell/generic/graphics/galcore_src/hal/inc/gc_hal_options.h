 ...
 * Gingerbread: bypass enable 
 * Honeycomb:   fullscreen go overlay pass
 * Please turn it off for lower android version
 * 
 */
#define MRVL_OPTI_TRIPLE_BUFFER             0
...
/*
 * Patch to avoid commit true returns
 * before hardware finish executing committed command buffer.
*/
#define MRVL_COMMIT_PATCH					0 

#if defined(ANDROID) && !defined(__QNXNTO__)
#define VIDEO_MEMORY_USE_PMEM 1
#define PMEM_MINOR_FLAG 1
#else
#define VIDEO_MEMORY_USE_PMEM 0
#endif
...
#define _EGL_VERSION_STRING_        "EGL 1.4";      
...
#define _GC_VERSION_STRING_        "GC Ver0.8.0.4375-TD-Gingerbread-Beta6"
