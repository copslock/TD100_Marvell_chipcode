...
*/
	...
	0x166,//0x177,change 24-bits to 18-bits
#else
	0x177,
#endif
	0X11,
...
#endif
	.active                 = 1,
	.spi_ctrl               = CFG_SCLKCNT(32) | CFG_TXBITS(9) | CFG_SPI_SEL(1) |
				  CFG_SPI_3W4WB(1) | CFG_SPI_ENA(1),
#ifdef CONFIG_TD100_JLJ
/*    .spi_gpio_cs            = -1,*/
	.spi_gpio_cs            = mfp_to_gpio(GPIO107_LCD_CS1),
	.spi_gpio_reset         = mfp_to_gpio(GPIO106_GPIO106),
#else
