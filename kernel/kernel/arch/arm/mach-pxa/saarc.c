...
static struct regulator_consumer_supply regulator_supply[] = {
	...
	[PM8607_ID_LDO14] = REGULATOR_SUPPLY("v_ldo14", "sdhci-pxa.1"),
};
...
static struct regulator_init_data regulator_data[] = {
	REG_INIT(BUCK1, 0, 1500000, 1, 1),
	REG_INIT(BUCK3, 0, 3000000, 1, 1),
	...
	REG_INIT(LDO8, 1800000, 2900000, 1, 1),
		  ...
		  void *data)
{
	...
	host->vmmc = regulator_get(&pdev->dev, "v_ldo14");
