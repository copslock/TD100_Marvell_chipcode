				...
				struct snd_pcm_hw_params *params, struct snd_soc_dai * dai)
{
	...
	case 48000:
		snd_soc_dai_set_clkdiv(cpu_dai, PXA3XX_SSP_AUDIO_DIV_ACPS, 0x2);
	...
	case 44100:
		...
		break;
	case 8000:
		snd_soc_dai_set_clkdiv(cpu_dai, PXA3XX_SSP_AUDIO_DIV_ACPS, 0x4);
		snd_soc_dai_set_clkdiv(cpu_dai, PXA3XX_SSP_AUDIO_DIV_ACDS, 0x5);
		if (params_channels(params) == 2)
			snd_soc_dai_set_clkdiv(cpu_dai, PXA3XX_SSP_AUDIO_DIV_SCDB, PXA3XX_SSP_CLK_SCDB_4);
		else if (params_channels(params) == 1)
			snd_soc_dai_set_clkdiv(cpu_dai, PXA3XX_SSP_AUDIO_DIV_SCDB, PXA3XX_SSP_CLK_SCDB_8);
		break;
	default:
		break;
	}
